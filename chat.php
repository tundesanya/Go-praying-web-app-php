                ...
                <div class="detail-signin">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="model-l">      
                            ...
                            <form method="post" class="signin-form" name="form1" id="chat_form"> 
                                <div class="form-group">
                                    <label for="usr">Your Name:</label> <td><b>tunde</b><br></td>
                                    
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Message:</label>
                                <td>
                                    <textarea  placeholder="* * * * * *" id="msgs" name="msg" class="form-control" required></textarea>
                                </td>
                                </div>    
                                <div class="form-group">                                
                                    <button type="submit" name="submit" id="submit" class="btn btn-lg btn-primary">Share</button>
                                </div>    
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-explain">
                        <h3>Multi-User chat Forum</h3>
                        <div class="content">
                            <div id="chatlogs" style="width:100%; text-align:left;">please wait.....!!!!! </div>
                        </div>
                        <p><a href="page-register.html" class="btn btn-lg btn-primary">Create new account</a> <a href="" class="btn btn-lg btn-default">See more..</a></p>
                    </div>
...
<script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(e){
                ...
                setInterval(function() {$('#chatlogs').load('logs.php');}, 0);  //put the amout of miliseconds at 0
              });
