                ...
                <div class="detail-signin">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-login">
                        <div class="model-l">      
                            ...
                            <form method="post" class="signin-form" action="login.php"> 
								            <?php include('errors.php'); ?>
                                <div class="form-group">
                                    <label for="usr">Username:</label>
                                    <input type="text" placeholder="Your username" id="userName" name="username" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">                                
                                    <button type="submit" name="login_user" class="btn btn-lg btn-primary"
                                    >Login</button>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-signup">
                        <div class="model-r">
                            <div class="o-r">
                                <span>OR</span>
                            </div>
                            ...
                            <form method="post" id="userRegisterFrm" action="login.php" class="signin-form" name="userRegisterFrm"> 
								                <?php include('errors.php'); ?>
                                <div class="form-group">
                                    <label for="usr">Username:</label>
                                    <input type="text" placeholder="For example: Henry Pham" name="username" value="<?php echo $username; ?>" class="form-control" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="usr">Email:</label>
                                    <input type="email" placeholder="For example: youremail@domain.com" name="email" value="<?php echo $email; ?>" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Password:</label>
                                    <input type="password" placeholder="* * * * * *" id="password" name="password_1" class="form-control" required>
                                </div>    
                                <div class="form-group">
                                    <label for="pwd">Confirm Password:</label>
                                    <input type="password" placeholder="* * * * * *" name="password_2" class="form-control"  required>
                                </div>  
                                <div class="form-group">                                
                                    <button type="submit" name="reg_user" class="btn btn-lg btn-primary">Create new account</button>
                                </div>
                            </form>
...
<div class="widget-joinus">
    <div class="container">
        ...
        <div class='description'>
            ...
            <div class="button">
                <a href="page-case-studies.html" class="button-default"><i class="fa fa-lightbulb-o" aria-hidden="true"></i> OUR CASE STUDIES</a>
            </div>
